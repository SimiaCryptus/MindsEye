...
```
    {
      ...
      "id": "9d13704a-9a5a-4ecb-a687-5c7c0002dd13",
      "isFrozen": true,
      "name": "EntropyLayer/9d13704a-9a5a-4ecb-a687-5c7c0002dd13"
    }
```
...
Logging: 
```
    Component: EntropyLayer/9d13704a-9a5a-4ecb-a687-5c7c0002dd13
    Inputs: [[ 0.5033053237761539,0.1674995794067038,0.8284688507468725 ]]
    output=[ 0.3455484411897128,0.2992839669810737,0.15589798758830972 ]
    measured/actual: [ [ -0.3134417225769681,0.0,0.0 ],[ 0.0,0.7867744067358018,0.0 ],[ 0.0,0.0,-0.8118239691601303 ] ]
    implemented/expected: [ [ -0.3134417124834622,-0.0,-0.0 ],[ 0.0,0.786774438724922,0.0 ],[ -0.0,-0.0,-0.8118239600103658 ] ]
    error: [ [ -1.0093505919961387E-8,0.0,0.0 ],[ 0.0,-3.1989120241604496E-8,0.0 ],[ 0.0,0.0,-9.149764501614754E-9 ] ]
