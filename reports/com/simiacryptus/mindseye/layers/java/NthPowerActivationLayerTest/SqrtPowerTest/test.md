...
```
    {
      ...
      "id": "9d13704a-9a5a-4ecb-a687-5c7c0002dd5a",
      "isFrozen": false,
      "name": "NthPowerActivationLayer/9d13704a-9a5a-4ecb-a687-5c7c0002dd5a",
      "power": 0.5
    }
```
...
Logging: 
```
    Component: NthPowerActivationLayer/9d13704a-9a5a-4ecb-a687-5c7c0002dd5a
    Inputs: [[ 0.2792544613204704,0.4640677199136285,0.0691652866591762 ]]
    output=[ 0.5284453248165513,0.6812251609516699,0.26299294032193377 ]
    measured/actual: [ [ 0.946171674343077,0.0,0.0 ],[ 0.0,0.7339717167376136,0.0 ],[ 0.0,0.0,1.9011916485567326 ] ]
    implemented/expected: [ [ 0.9461716785432325,0.0,0.0 ],[ 0.0,0.7339717154626251,0.0 ],[ 0.0,0.0,1.9011917178763134 ] ]
    error: [ [ -4.200155445666098E-9,0.0,0.0 ],[ 0.0,1.274988559174517E-9,0.0 ],[ 0.0,0.0,-6.931958074218869E-8 ] ]
