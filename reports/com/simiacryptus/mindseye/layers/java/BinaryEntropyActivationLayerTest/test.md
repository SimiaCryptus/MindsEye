...
```
    {
      ...
      "id": "9d13704a-9a5a-4ecb-a687-5c7c0002dd06",
      "isFrozen": true,
      "name": "BinaryEntropyActivationLayer/9d13704a-9a5a-4ecb-a687-5c7c0002dd06"
    }
```
...
Logging: 
```
    Component: BinaryEntropyActivationLayer/9d13704a-9a5a-4ecb-a687-5c7c0002dd06
    Inputs: [[ 0.034467091480455125,0.7047626936222025,0.32467446707182834 ]]
    output=[ -0.14994271380825308,-0.6067747091561437,-0.6303428588624385 ]
    measured/actual: [ [ -3.332675047040823,0.0,0.0 ],[ 0.0,0.8700816955808932,0.0 ],[ 0.0,0.0,-0.7323718076435171 ] ]
    implemented/expected: [ [ -3.3326751870382143,-0.0,-0.0 ],[ 0.0,0.870081679996937,0.0 ],[ -0.0,-0.0,-0.732371805047547 ] ]
    error: [ [ 1.3999739145731382E-7,0.0,0.0 ],[ 0.0,1.5583956236575602E-8,0.0 ],[ 0.0,0.0,-2.5959701055455753E-9 ] ]
