...
```
    {
      ...
      "id": "9d13704a-9a5a-4ecb-a687-5c7c0002dd1c",
      "isFrozen": false,
      "name": "HyperbolicActivationLayer/9d13704a-9a5a-4ecb-a687-5c7c0002dd1c",
      "weights": {
        "dimensions": [
          2
        ],
...
Logging: 
```
    Component: HyperbolicActivationLayer/9d13704a-9a5a-4ecb-a687-5c7c0002dd1c
    Inputs: [[ 0.9969167479705183,0.02769916616880974,0.0022750138290306143 ]]
    output=[ 0.4120350570662592,3.835483485559177E-4,2.5878406126889075E-6 ]
    measured/actual: [ [ 0.7060141804515752,0.0,0.0 ],[ 0.0,0.027688540349402047,0.0 ],[ 0.0,0.0,0.0022750246131408858 ] ]
    implemented/expected: [ [ 0.7060141623125001,0.0,0.0 ],[ 0.0,0.027688546272612965,0.0 ],[ 0.0,0.0,0.0022750079416726686 ] ]
    error: [ [ 1.813907501979628E-8,0.0,0.0 ],[ 0.0,-5.923210918273858E-9,0.0 ],[ 0.0,0.0,1.6671468217217822E-8 ] ]
