...
public class SubsampleLayer extends NNLayer implements LayerPrecision<SubsampleLayer> {
   ...
   * @param json the json
   */
  protected SubsampleLayer(final JsonObject json) {
    super(json);
   ...
   * @return the max bands
   */
  public SubsampleLayer setMaxBands(final int maxBands) {
  ...
  @Override
  public SubsampleLayer setPrecision(final Precision precision) {
