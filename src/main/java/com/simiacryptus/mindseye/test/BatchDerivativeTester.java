 ...
 */
public class BatchDerivativeTester implements DerivativeTester {
  
  private static final Logger log = LoggerFactory.getLogger(BatchDerivativeTester.class);
   ...
   */
  public BatchDerivativeTester(double tolerance, double probeSize) {
