...
public class NDArrayDouble {
  ...
  public NDArrayDouble(final int... dims) {
    this(dims, null);
  }

  public NDArrayDouble(final int[] dims, final double[] data) {
  ...
  public NDArrayDouble set(final double[] data) {
