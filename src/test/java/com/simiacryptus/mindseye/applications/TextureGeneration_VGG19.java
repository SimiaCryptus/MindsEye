 ...
 */
public class TextureGeneration_VGG19 extends ArtistryAppBase_VGG19 {
  ...
  public void run(@Nonnull NotebookOutput log) {
    ...
    textureStyle.put(vangogh, new TextureGeneration.StyleCoefficients(TextureGeneration.CenteringMode.Origin)
