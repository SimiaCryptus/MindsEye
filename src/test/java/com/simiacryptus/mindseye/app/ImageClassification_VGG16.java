 ...
 */
public abstract class ImageClassification_VGG16 extends ImageClassificationBase {
  /**
   * Gets target class.
   *
   ...
   * The type HDF5_JBLAS.
   */
  public static class HFD5 extends ImageClassification_VGG16 {
    ...
    public ImageClassifier loadModel(@Nonnull final NotebookOutput log) {
      return log.code(() -> {
        ImageClassifier classifier = VGG16.fromHDF5();
   ...
   * The type HDF5_JBLAS.
   */
  public static class HDF5_JBLAS extends ImageClassification_VGG16 {
