...
public abstract class SimpleConvolutionLayerTest extends CudaLayerTestBase {
   ...
   * @param mode      the mode
   */
  protected SimpleConvolutionLayerTest(final int radius, final int bands, final Precision precision, int stride, final ActivationLayer.Mode mode) {
    this.radius = radius;
    this.bands = bands;
    layer = new SimpleConvolutionLayer(radius, radius, bands, bands, mode).setPrecision(precision).setStrideX(stride).setStrideY(stride).setWeightsLog(-2);
  ...
  public static class Basic extends SimpleConvolutionLayerTest {
     ...
     */
    public Basic() {
      super(1, 1, Precision.Double, 1, ActivationLayer.Mode.RELU);
    }
  }
  ...
  public static class Image extends SimpleConvolutionLayerTest {
     ...
     */
    public Image() {
      super(3, 3, Precision.Double, 1, ActivationLayer.Mode.RELU);
      largeSize = 1200;
      smallSize = 5;
    }
  }
  ...
  public static class Image_Float extends SimpleConvolutionLayerTest {
     ...
     */
    public Image_Float() {
      super(3, 3, Precision.Float, 1, ActivationLayer.Mode.RELU);
      tolerance = 1e-2;
    }
  ...
  public static class Matrix extends SimpleConvolutionLayerTest {
     ...
     */
    public Matrix() {
      super(3, 1, Precision.Double, 1, ActivationLayer.Mode.RELU);
    }
  }
  ...
  public static class MultiBand extends SimpleConvolutionLayerTest {
     ...
     */
    public MultiBand() {
      super(1, 3, Precision.Double, 1, ActivationLayer.Mode.RELU);
    }
  }
  ...
  public abstract static class Bug_Control extends SimpleConvolutionLayerTest {
    ...
    protected Bug_Control() {
      super(3, 8, Precision.Double, 1, ActivationLayer.Mode.RELU);
  ...
  public abstract static class Big extends SimpleConvolutionLayerTest {
    ...
    public Big(int radius, int bands, Precision aDouble) {
      super(radius, bands, aDouble, 1, ActivationLayer.Mode.RELU);
      validateDifferentials = false;
