...
public class MNISTClassificationTests4 extends MNISTClassificationTest {
  ...
  public NNLayer<DAGNetwork> buildNetwork() {
    ...
    net.add(new ConvolutionSynapseLayer(new int[] { 3, 3 }, 4).addWeights(() -> Util.R.get().nextGaussian() * .001));
    net.add(new MaxSubsampleLayer(new int[] { 2, 2, 1 }));

    net.add(new SigmoidActivationLayer());
    net.add(new ConvolutionSynapseLayer(new int[] { 2, 2 }, 16).addWeights(() -> Util.R.get().nextGaussian() * .01));
    net.add(new MaxSubsampleLayer(new int[] { 3, 3, 1 }));

    net.add(new SigmoidActivationLayer());
    net.add(new ConvolutionSynapseLayer(new int[] { 2, 2 }, 16).addWeights(() -> Util.R.get().nextGaussian() * .1));

    //net.add(new SumSubsampleLayer(new int[] { 3, 3, 1 }));
