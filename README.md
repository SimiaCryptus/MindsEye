...
**Project Website** - [https://simiacryptus.github.io/MindsEye/](https://simiacryptus.github.io/MindsEye/) - The current maven-published site

**JavaDocs** - [https://simiacryptus.github.io/MindsEye/apidocs/index.html](https://simiacryptus.github.io/MindsEye/apidocs/index.html) - Code documentation for the current release

**Maven** - [http://mvnrepository.com/artifact/com.simiacryptus/mindseye](http://mvnrepository.com/artifact/com.simiacryptus/mindseye) - Dependency import info

**Blog Articles** - [http://simiacryptus.com](http://simiacryptus.com) - Related articles from the author

## Features

* Java-based environment - Use Java 8, Scala, or any other JVM language.

* A highly modular optimization engine - It can be configured for many popular algorithms, or customized for optimization or research.

* Support for multiple GPUs and high performance math using native libraries including CuDNN, CUDA, and OpenCL.

* Use server clusters with Apache Spark for data-parallel training.

* A large and extensible component library, allowing pure-Java and GPU-based components to be seamlessly integrated into arbitrarily complex networks.

* Built-in JSON serialization for all networks

* A focus on automated testing and documentation generation provides high quality, transparency, and scalability,
